    ...
    , mQos(1)
{
    ...
    // foxy : set_on_parameters_set_callback(std::bind(&ApcCamera::paramChange_callback, this, _1));
    // humble 
    this->add_on_set_parameters_callback(
        std::bind(&ApcCamera::paramChange_callback, this, std::placeholders::_1)
    );
...
void ApcCamera::setDefaultParams() {
    ...
    this->declare_parameter<int>("depth_maximum_mm", 2500, descriptor);
