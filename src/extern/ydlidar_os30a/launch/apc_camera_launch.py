...
def generate_launch_description():
    ...
    COLOR_TF_node = Node(
        package='tf2_ros', executable='static_transform_publisher', name="camera_left_color_broadcaster", output='screen',
            arguments=["0", "0.05", "0", "0", "0", "0", "dm_base_frame", "left_color_frame"]
    )
    DEPTH_TF_node = Node(
        package='tf2_ros', executable='static_transform_publisher', name="camera_depth_broadcaster", output='screen',
            arguments=["0", "0.05", "0", "0", "0", "0", "dm_base_frame", "depth_frame"]
    )
    PC_TF_node = Node(
    ...
    DM_TF_node = Node(
        package='tf2_ros', executable='static_transform_publisher', name='dm_broadcaster' ,output='screen',
            arguments=["0.2", "0", "0", "0", "0", "0", "base_link", "dm_base_frame"]
    )
    RVIZ_node = Node(
