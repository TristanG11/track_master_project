...
from track_master_debug.srv import GetCmdType, GetCmdTypeResponse
...
class AppInitializer(Node):
    def __init__(self):
        ...
        self.current_cmd_type = "app_joystick"
    ...
    def handle_get_cmd_type(self, request, response: GetCmdTypeResponse):
